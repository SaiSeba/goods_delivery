...
public class DefaultMissionListModel extends AbstractTableModel {

	private List<ScheduleList> items;

	public DefaultMissionListModel() {
		items = new ArrayList<>(25);
	}

	public DefaultMissionListModel(List<ScheduleList> items) {
		this.items = items;
	}
...
//		this.status=status;
		...
		case 5:
			return item.getstatus() == 1 ? "Completed" : "Not Completed";
		}
		return null;
	}
